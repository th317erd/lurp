...
function resolveURL(location, _urlish, magic) {
  ...
  const internalResolve = (_location, _urlPart, magic) => {
    ...
    // Magic!
    if (magic !== false && !HAS_FILENAME.test(urlish)) {
