...
export class MythixUIComponent extends HTMLElement {
   ...
   *   1. `resolve<function>` - When called, resolves the promise with the first provided argument
   *   2. `reject<function` - When called, rejects the promise with the first provided argument
   *   3. `status<function>` - When called, will return the fulfillment status of the promise, as a `string`, one of: `"fulfilled"`, or `"rejected"`
